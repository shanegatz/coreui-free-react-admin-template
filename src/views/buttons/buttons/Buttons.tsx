    ...
    <>
      <CCard>
        ...
        <CCardBody>
          <CRow className="align-items-center">
            <CCol xl className="col-12 mb-3 mb-xl-0">
              Normal
            </CCol>
            <CCol sm="4" md="2" xl className="col-6 mb-3 mb-xl-0">
      ...
      <CCard>
        ...
        <CCardBody>
          ...
          <CRow className="align-items-center">
            ...
            <CCol sm="4" md="2" xl className="col-6 mb-3 mb-xl-0"></CCol>
          </CRow>
          <CRow className="align-items-center mt-3">
            <CCol xl className="col-12 mb-3 mb-xl-0">
              Active State
      ...
      <CCard>
        ...
        <CCardBody>
          ...
          <CRow className="align-items-center">
            <CCol xl className="col-2 mb-3 mb-xl-0">
              Small
            </CCol>
            <CCol className="col-2 mb-3 mb-xl-0 text-center">
      ...
      <CCard>
        ...
        <CCardBody>
          <CRow className="align-items-center mt-3">
            <CCol className="col-2 text-center mt-3">
